...
export type RealtimeAttendanceQuery = z.infer<
  typeof realtimeAttendanceQuerySchema
>;

export type MyAttendanceHistoryQuery = z.infer<
  typeof myAttendanceHistoryQuerySchema
>;
