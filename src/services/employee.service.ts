...
const formatEmployee = (employee: EmployeeWithRelations) => {
  return {
    id: employee.id,
    nik: employee.nik,
...
const mapUniqueConstraintError = (error: unknown): never => {
  if (
...
export const employeeService = {
  async createEmployee(payload: CreateEmployeeBody) {
